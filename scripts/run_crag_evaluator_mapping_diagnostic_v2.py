...
from ragtune.rc1_maturity import run_crag_evaluator_mapping_v2
...
def main() -> int:
    ...
    parser.add_argument("--config", default="configs/experiments/ragtune_crag_evaluator_mapping_diagnostic_v2.yaml")
