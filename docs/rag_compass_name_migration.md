# RAG Compass Name Migration

`RAG Compass` is the forward-facing display name for the optimizer historically identified as `ragtune_no_fork`.

Machine-readable identifiers remain stable:
