...
- Generative LLM Validation v1.1 adds bounded local HotpotQA and CRAG quality-signal audits with Ollama `qwen3:8b` and sanitized metrics. It remains inconclusive: neither dataset showed governance improvement under the bounded samples. It does not move the program to Level 7.
